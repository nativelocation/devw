	...
	render() {
		...
		return (
			<div className='h-100 p-0 d-flex flex-column' style={{ flex: 1, maxWidth }}>
				<div className='col-md-12 col-lg-12 d-flex flex-column' style={styles.flex}>
					<div className='col-md-12 col-lg-12 m-0 p-3' style={{ flex: "unset" }}>
						...
						>
							{`${account.firstName} ${account.lastName}`} <span className='jam jam-chevron-down' />
						</a>
						<div className='dropdown-menu dropdown-menu-right logoutBox mr-4'>
							<Link to='/profile' className='dropdown-item pointer text-muted'>
								Profile
							</Link>
							<a className='dropdown-item pointer text-muted' onClick={this.onLogout}>
								Logout
							</a>
						</div>
						<Link
					...
					<div className='col-md-12 col-lg-12 bg-white d-flex flex-column' style={styles.flex}>
						{children}
					</div>
				</div>
			</div>
